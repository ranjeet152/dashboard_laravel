            ...
            <div class="tab-content">
                <div class="tab-pane active" id="trending">
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-1.jpg') }}" alt="" class="thumbnail">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-2.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-3.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-4.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-5.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-6.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-7.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-8.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                ...
                <div class="tab-pane fade" id="best-seller">
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-9.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-11.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-12.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-13.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-14.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-15.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-product">
                            <div class="product-block">
                                <img src="{{ url('images/product-16.jpg') }}" alt="" class="thumbnail">
                                <div class="product-description text-center">
                                    <p class="title">Date Tiffany Torchiere</p>
                                    <p class="price">$ 55.00</p>
                                </div>
